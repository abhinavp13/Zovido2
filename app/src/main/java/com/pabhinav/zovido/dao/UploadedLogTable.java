 ...
 * @author pabhinav
 */
public class UploadedLogTable {

    private static final String TABLE_NAME = "uploadedLogTable";
    ...
    public static ContentValues getContentValues(UploadedLogsDataParcel dataParcel){
