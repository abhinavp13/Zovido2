                        ...
                        public void onComplete(FirebaseError firebaseError, Firebase firebase) {
                            if (firebaseError != null) {
                                ...
                                if(ZovidoApplication.getInstance() != null) {
                                    ZovidoApplication.getInstance().trackEvent("Firebase", "Feedback", "Feedback was sent by user");
                                }
                            }
                        }
                    });
                    ...
                    myFirebaseRef.child("ACRA " + date).setValue(acraMap, new Firebase.CompletionListener() {
                        ...
                        public void onComplete(FirebaseError firebaseError, Firebase firebase) {
                            if (firebaseError != null) {
                                ...
                                if (ZovidoApplication.getInstance() != null) {
                                    ZovidoApplication.getInstance().trackEvent("Firebase", "Error", "Exception caught by ACRA !!!");
                                }
                            }
                        }
                    });
